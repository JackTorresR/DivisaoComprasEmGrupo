    ...
    <Section
      ...
      actions={
        <CopyButton
          ...
          onCopy={() =>
            navigator.clipboard.writeText(buildShoppingListText(items))
          }
        />
      }
    >
      {items.length === 0 ? (
        <EmptyState
          ...
          description="Os produtos cadastrados aparecem aqui automaticamente."
        />
      ) : (
        <ScrollArea label="Lista de compras" size="md">
